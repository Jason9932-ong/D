...
const I18N = {
  en: {
    ...
    reset_sent: "Password reset link sent to your email ✉️",
    ...
    pass_keep: "New password (leave blank to keep)",
    fn_hint: "To change email/password, deploy the admin-update-client function (see SETUP.md).",
  ...
  zh: {
    ...
    reset_sent: "重置链接已发到你的邮箱 ✉️",
    enter_email_first: "请先在上方输入邮箱。",
    set_new_password: "设置新密码",
    new_password: "新密码",
    save_password: "保存密码",
    password_updated: "密码已更新——已为你登录。",
    pass_short: "密码至少 6 位。",
    logout: "退出",
    loading: "加载中…",
    back: "← 返回",
    ...
    pass_keep: "新密码（留空则不修改）",
    fn_hint: "要修改邮箱/密码，请先部署 admin-update-client 函数（见 SETUP.md）。",
